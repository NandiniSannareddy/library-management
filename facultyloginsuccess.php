...
$password=$_POST['password'];
   ...
   $check=mysqli_query($connect, "SELECT * FROM faculty WHERE username='$username' and password='$password' ");


$count=mysqli_num_rows($check);
   if($count>0){
      header("Location:facultyaddbooks.php");
   }
   else{
...
<div class="login-container">
    <h2>Faculty Login</h2>
    <form  method="post" enctype="multipart/form-data" action="facultyloginsuccess.php">
